...
import 'dairy page.dart';
class dairy_entry extends StatefulWidget {
  const dairy_entry({Key? key}) : super(key: key);

  @override
  State<dairy_entry> createState() => _dairy_entryState();
}

class _dairy_entryState extends State<dairy_entry> {
  @override
          ...
          child: ListView(
            children: <Widget>[
              GestureDetector(onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>dairy_page()));
              },
                child:
                Card(
